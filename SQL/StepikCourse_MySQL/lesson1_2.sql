--Вывести информацию о всех книгах, хранящихся на складе (т.е. показать таблицу целиком)
...
SELECT title,                                                             --Приоритеты операций:
author,                                                                   --1. круглые скобки
price,                                                                    --2. умножение  (*),  деление (/)
amount                                                                    --3. сложение  (+), вычитание (-)
FROM book                                                                 --4. операторы сравнения (=, >, <, >=, <=, <>), BETWEEN, IN 
WHERE (price < 500 OR price > 600) AND amount * price >= 5000;            --5. NOT
                                                                          --6. AND
                                                                          --7. OR
...
SELECT author,                                                  --ORDER BY сортировка
title                                                           --ASC сортировка по возрастанию
FROM book                                                       --DESC сортировка по убыванию
